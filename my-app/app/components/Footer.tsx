  ...
  <footer className="w-full bg-black py-8 px-4">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start">
      ...
      <div className="flex flex-col items-center mb-6 md:mb-0">
        ...
        />
  <img src="/images/logo_white.png" alt="Twelve Studio Logo" className="h-10 w-auto mb-4" />
  <span className="text-white text-xs mt-4 block">© {new Date().getFullYear()} twelveAM . All rights reserved.</span>
      ...
      <div className="flex flex-col items-start text-white">
        ...
        <div className="flex space-x-2 mb-4">
          ...
          <img src="https://play-lh.googleusercontent.com/WU6sZMD1UspzwqYnlACtmN60rckp8hoINSgsR21mKLJBbsHPwXtzwvOocpjC7FcO1g" alt="Pay" className="h-6" />
          <img src="https://logos-world.net/wp-content/uploads/2020/05/Visa-Logo-700x394.png" alt="Visa" className="h-6" />
